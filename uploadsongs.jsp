...
<input type="text" onkeyup="filter();filtery();filtert();filterr()" id="myInput" placeholder="Search Songs here">
    ...
    <div id="hsongs">
      ...
      <br>
      <div class="uploading">
          <form action="upsuccess.jsp?name=<%out.print(usname);%>" method="post" class="frm">
          ...
          <br>
          <br>
          <input type="submit" name="action" class="do" value="Upload Song">
      </form>
          </div>
    </div>
