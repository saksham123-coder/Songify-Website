...
<head>
    <meta charset="UTF-8">
    <title>Songify-All uploads</title>
...
<input type="text" onkeyup="filter();filtery();filterr()" id="myInput" placeholder="Search Radio here">
    ...
    <ul id="playlist">
       ...
       %>
       <li><a><iframe width="320" height="300" src="<%out.print("https://www.youtube.com/embed/"+rs.getString("url"));%>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><pre><% out.print(rs.getString("name")+"-"+rs.getString("song name")); %></pre></a></li>
                    <%
